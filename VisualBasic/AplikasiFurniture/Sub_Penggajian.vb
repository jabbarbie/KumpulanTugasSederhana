...
Public Class Sub_Penggajian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.Sub_Penggajian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSub_Penggajian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sub_Penggajian = New Sub_Penggajian
        rpt.Site = Me.Site
        Return rpt
    End Function
