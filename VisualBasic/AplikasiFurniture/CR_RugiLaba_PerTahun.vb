...
Public Class CR_RugiLaba_PerTahun
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CR_RugiLaba_PerTahun.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.CR_RugiLaba_PerTahun.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_RugiLaba_PerTahun
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_RugiLaba_PerTahun = New CR_RugiLaba_PerTahun
        rpt.Site = Me.Site
        Return rpt
    End Function
