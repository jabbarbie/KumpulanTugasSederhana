...
Public Class CR_Penjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.CR_Penjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Penjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Penjualan = New CR_Penjualan
        rpt.Site = Me.Site
        Return rpt
    End Function
