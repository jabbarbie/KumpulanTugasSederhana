...
Public Class CR_DataBarang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.CR_DataBarang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_DataBarang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_DataBarang = New CR_DataBarang
        rpt.Site = Me.Site
        Return rpt
    End Function
