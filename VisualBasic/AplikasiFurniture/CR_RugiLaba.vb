...
Public Class CR_RugiLaba
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.CR_RugiLaba.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_RugiLaba
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_RugiLaba = New CR_RugiLaba
        rpt.Site = Me.Site
        Return rpt
    End Function
