...
Public Class Sub_Penjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.Sub_Penjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSub_Penjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Sub_Penjualan = New Sub_Penjualan
        rpt.Site = Me.Site
        Return rpt
    End Function
