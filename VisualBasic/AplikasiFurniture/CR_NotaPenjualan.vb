...
Public Class CR_NotaPenjualan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.CR_NotaPenjualan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_NotaPenjualan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_NotaPenjualan = New CR_NotaPenjualan
        rpt.Site = Me.Site
        Return rpt
    End Function
