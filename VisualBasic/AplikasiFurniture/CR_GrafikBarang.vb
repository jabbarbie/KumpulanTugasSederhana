...
Public Class CR_GrafikBarang
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.CR_GrafikBarang.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_GrafikBarang
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_GrafikBarang = New CR_GrafikBarang
        rpt.Site = Me.Site
        Return rpt
    End Function
