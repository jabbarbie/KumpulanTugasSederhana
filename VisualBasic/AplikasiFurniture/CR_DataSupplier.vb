...
Public Class CR_DataSupplier
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.CR_DataSupplier.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_DataSupplier
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_DataSupplier = New CR_DataSupplier
        rpt.Site = Me.Site
        Return rpt
    End Function
