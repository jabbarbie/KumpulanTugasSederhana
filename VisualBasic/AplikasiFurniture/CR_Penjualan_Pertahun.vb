...
Public Class CR_Penjualan_Pertahun
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CR_Penjualan_Pertahun.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.CR_Penjualan_Pertahun.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Penjualan_Pertahun
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Penjualan_Pertahun = New CR_Penjualan_Pertahun
        rpt.Site = Me.Site
        Return rpt
    End Function
