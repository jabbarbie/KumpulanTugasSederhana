...
Public Class CR_Penggajian
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Aplikasi_Furniture_3.CR_Penggajian.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Penggajian
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Penggajian = New CR_Penggajian
        rpt.Site = Me.Site
        Return rpt
    End Function
