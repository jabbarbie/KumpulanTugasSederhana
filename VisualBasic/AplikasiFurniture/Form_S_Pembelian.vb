Public Class Form_S_Pembelian
    ...
    Private Sub b_cetak_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles b_cetak.Click
        If (R_PerPeriode.Checked = True) Then
            Form_V_Pembelian.Label1.Text = "WHERE (tanggal_transaksi) BETWEEN #" & tgl_dari.Text & "# AND #" & tgl_sampai.Text & "#"
            Form_V_Pembelian.Label2.Text = "CR_Pembelian_PerPeriode"
        ElseIf (R_PerTahun.Checked = True) Then
            If num_tahun.Value <= 2010 Then
                MsgBox("Tahun tidak valid.. !", MsgBoxStyle.Critical, "Pesan")
                Exit Sub
            End If
            Form_V_Pembelian.Label1.Text = "WHERE (YEAR(tanggal_transaksi) = " & num_tahun.Value & ") "
            Form_V_Pembelian.Label2.Text = "CR_Pembelian_Pertahun"
        ElseIf (R_Semua.Checked = True) Then
            Form_V_Pembelian.Label1.Text = ""
            Form_V_Pembelian.Label2.Text = "CR_Pembelian"
        End If

        Form_V_Pembelian.ShowDialog()
    End Sub
